...
contract ExampleSwapToPrice {
    ...
    IBulletRouter01 public immutable router;
    address public immutable factory;

    constructor(address factory_, IBulletRouter01 router_) public {
        factory = factory_;
        router = router_;
    }
    ...
    function swapToPrice(
        ...
        uint256 amountIn;
        {
            (uint256 reserveA, uint256 reserveB) = BulletLibrary.getReserves(factory, tokenA, tokenB);
